...
class DeepSpeedRLHFEngine:
    ...
    def _init_critic(self, critic_model_name_or_path):
        ...
        #     offload=False, dtype=self.args.dtype, stage=self.args.critic_zero_stage
        # )
        ...
        # Optimizer
        AdamOptimizer = (
            DeepSpeedCPUAdam if self.args.offload_critic_model else FusedAdam
        )
        optim_params = get_optimizer_grouped_parameters(
            critic_model,
        ...
        optim = AdamOptimizer(
            optim_params, lr=self.args.critic_learning_rate, betas=(0.9, 0.95)
        )
