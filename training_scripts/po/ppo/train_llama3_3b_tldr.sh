...
MODEL_PATH="./model"
ACTOR_MODEL_PATH="${MODEL_PATH}/step1_sft-Llama3_3b-tl_dr-2024-10-25-02-55-49-1234"
CRITIC_MODEL_PATH="${MODEL_PATH}/step2_reward-Llama3_3b-tl_dr-2024-10-25-03-37-12-1234"
ACTOR_ZERO_STAGE=2
CRITIC_ZERO_STAGE=2
...
OUTPUT="${LOG_PATH}/step3_ppo-Llama3_3b-tl_dr-$TIME_STEP-$SEED"
